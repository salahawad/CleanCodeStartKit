...
var _default = {
  ...
  create(context) {
    return {
      CallExpression(node) {
        if (!((0, _util.expectNotCase)(node) || (0, _util.expectResolveCase)(node) || (0, _util.expectRejectCase)(node)) && (0, _util.expectCase)(node) && ((0, _util.method)(node).name === 'toBe' || (0, _util.method)(node).name === 'toEqual') && node.arguments[0].property && node.arguments[0].property.name === 'length') {
