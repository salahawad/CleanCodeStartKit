...
var _default = {
  ...
  create(context) {
    return {
      CallExpression(node) {
        if (!((0, _util.expectResolveCase)(node) || (0, _util.expectRejectCase)(node)) && (0, _util.expectCase)(node) && (isEqualityNegation(node) || isValidEqualityCheck(node)) && isValidIncludesMethod(node)) {
          context.report({
            fix(fixer) {
